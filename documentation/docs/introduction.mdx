...
RSocket is a protocol built over TCP which provides reactive communication between client and server.
...
```
3. Run `dart pub get`.
4. Refer to the API for implementation details. Enjoy!
